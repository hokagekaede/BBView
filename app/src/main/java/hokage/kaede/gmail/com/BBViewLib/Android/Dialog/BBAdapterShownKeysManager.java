...
/**
 * リストに表示する項目のキーを選択するためのダイアログ管理クラス
 */
public class BBAdapterShownKeysManager implements OnClickListener, OnMultiChoiceClickListener, OnCancelListener {
	 ...
	 * 初期化を行う。
	 */
	public BBAdapterShownKeysManager(Activity activity, ArrayList<String> keys) {
		mActivity = activity;
		mListener = null;
	...
	public void updateSetting() {
		String key = BBAdapterShownKeysManager.class.getSimpleName() + "/" + mSaveKey;
