package hokage.kaede.gmail.com.BBViewLib.Android.Dialog;
 ...
 * ソート項目選択用のダイアログ管理クラス
 */
public class BBAdapterSortKeyManager implements OnClickListener, OnCheckedChangeListener {
	 ...
	 * 初期化処理を行う。
	 */
	public BBAdapterSortKeyManager(Activity activity, ArrayList<String> target_keys) {
		mActivity = activity;
	...
	public void setSaveKey(String save_key) {
		mSaveSpecKey = BBAdapterSortKeyManager.class.getSimpleName() + "/" + save_key + ":spec";
		mSaveAscKey = BBAdapterSortKeyManager.class.getSimpleName() + "/" + save_key + ":asc";
	}
