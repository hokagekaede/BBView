...
import hokage.kaede.gmail.com.BBViewLib.Android.CommonLib.BBExpandableAdapter;
...
import hokage.kaede.gmail.com.BBViewLib.Android.CommonLib.BBAdapterCmdManager.IndexLayout;
import hokage.kaede.gmail.com.StandardLib.Java.FileArrayList;

/**
 * 「パーツ武器選択」画面のカテゴリ表示の一覧を生成するクラス。
 */
public class BBDataExpandableAdapter extends BBExpandableAdapter {
	 ...
	 * コンストラクタ。リストを初期化する。
	 */
	public BBDataExpandableAdapter(boolean is_parts) {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		BBDataAdapterItem view;

		if(convertView == null) {
			view = new BBDataAdapterItem(context, mShownKeys);
			...
			view = (BBDataAdapterItem)(convertView);
			view.setShowTypeB(mIsShowTypeB);
	...
	private class OnClickFavListener implements OnClickListener {
		...
		public void onClick(View view) {
			...
			BBDataExpandableAdapter.this.notifyDataSetChanged();
		}
	}
}
