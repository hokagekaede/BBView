...
/**
 * リストでフィルタリング対象とする項目を選択するためのダイアログ管理クラス
 */
public class BBAdapterFilterManager implements OnClickListener, OnMultiChoiceClickListener {
	 ...
	 * @param filter
	 */
	public BBAdapterFilterManager(Activity activity, BBDataFilter filter) {
		mActivity = activity;
		mFilter = filter;
		mListener = null;
