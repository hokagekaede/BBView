...
import hokage.kaede.gmail.com.BBViewLib.Android.CommonLib.BBDataBaseAdapterItem;
 ...
 */
public class ChipAdapterItem extends BBDataBaseAdapterItem {
	...
	public ChipAdapterItem(Context context, ArrayList<String> keys) {
		super(context, keys);
