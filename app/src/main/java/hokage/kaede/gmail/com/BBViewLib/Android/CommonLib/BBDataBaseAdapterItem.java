...
/**
 * 表示項目一覧のスペック表示など、アイテム一覧の中の表示内容を生成するクラス。
 */
public abstract class BBDataBaseAdapterItem extends LinearLayout {
	 ...
	 */
	public BBDataBaseAdapterItem(Context context, ArrayList<String> keys) {
		super(context);
		mShownKeys = keys;
		mIsShowTypeB = false;
