 ...
 */
public class ChipExpandableAdapter extends BBExpandableAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		ChipAdapterItem checkbox = (ChipAdapterItem)convertView;
		
		if(checkbox == null) {
			checkbox = new ChipAdapterItem(parent.getContext(), null);
			checkbox.createView();
	...
	private class OnCheckedFlagListener implements OnCheckedChangeListener {
		...
		public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
			...
			ChipExpandableAdapter.this.notifyDataSetChanged();
		}
	}
