...
import hokage.kaede.gmail.com.StandardLib.Java.EncryptionUtillity;
...
/**
 * ログインダイアログの表示とIDおよびパスワードを保持するクラス。
 */
public class UidDialog implements OnClickListener {
	 ...
	 * @param activity
	 */
	public UidDialog(Activity activity) {
		mActivity = activity;
